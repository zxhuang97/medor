...
from utils.cloth3d.DataReader.smpl.smpl_np import SMPLModel
from utils.cloth3d.DataReader.util import loadInfo, zRotMatrix, proj, mesh2UV, uv_to_pixel
from cloth3d.DataReader.IO import readOBJ, readPC2Frame
...
class DataReader:
	...
	def __init__(self, src=None):
		...
		self.SRC = os.path.abspath(os.path.dirname(__file__)) + '/../Samples/' if src is None else src
		# SMPL model
	...
	def read_garment_canon_Vert(self, sample, garment):
		obj_path = os.path.join(self.SRC, sample, garment + '.obj')
		return readOBJ(obj_path)[0]
	"""	
