...
from utils.camera_utils import get_observable_particle_index
...
from utils.misc_utils import voxelize_pointcloud
from utils.data_utils import read_h5_dict


class ClothDatasetPointCloudEdge(ClothDynDataset):
    ...
    def _prepare_transition(self, idx, eval=False):
        ...
        while not success:
            ...
            data = read_h5_dict(data_path, self.data_names)
